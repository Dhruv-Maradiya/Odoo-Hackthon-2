  ...
  return (
    <Box className='content-right' sx={{ backgroundColor: 'background.paper' }}>
      {!hidden ? (
        ...
        >
          <SetPasswordIllustration alt='set-password-illustration' src='/login.png' />
            ...
            <Box sx={{ width: '100%', maxWidth: 400 }}>
              <Box sx={{ my: 6 }}>
                <Typography sx={{ mb: 1.5, fontWeight: 500, fontSize: '1.625rem', lineHeight: 1.385 }}>
                  Oops! 😖 Your set password link has expired or is invalid!
                </Typography>
              </Box>
...
SetPassword.getLayout = page => <BlankLayout>{page}</BlankLayout>
SetPassword.guestGuard = true
